...
public class NewAutoRevFlywheelsIndefinitely extends Command {
  ...
  public NewAutoRevFlywheelsIndefinitely(double speedRPS, BlinkinLED LED, IntakeSubsystem intakeSubsystem) {
    this.LED = LED;
  ...
  public void initialize() {
    intake.getLeftIntakeMotor().atSetpointPosition(desiredSpeedRPS);
