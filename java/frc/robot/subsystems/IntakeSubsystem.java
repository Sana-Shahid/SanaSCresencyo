...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public IntakeSubsystem() {
    ...
    //to both motors
   var talonFXConfigs = TalonHelper.createTalonConfig(IntakeConstants.PIDConstants.kIntakeP, IntakeConstants.PIDConstants.kIntakeI, IntakeConstants.PIDConstants.kIntakeD, IntakeConstants.PIDConstants.kIntakeV, IntakeConstants.PIDConstants.kIntakeS, IntakeConstants.kStatorCurrentLimit, IntakeConstants.kFlywheelsGearRatio,IntakeConstants.PIDConstants.kIntakePIDMaxOutput);
